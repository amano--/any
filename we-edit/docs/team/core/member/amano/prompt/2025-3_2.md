...
チームのパフォーマンスを上げるためチームメンバー各自に対してミッションを設定したいと考えています。
そのミッションを設定する上で役にたつメンバー向けミッション設定テンプレートを考案して
docs/team/core/member/amano/misson
に保存してください。
...
なので、新しいガイドラインに従った新資料は、　hypothesis-testing1フォルダを作成した後、そこに作成してください。
また、新資料を作成する前は旧資料を、ガイドライン追記に役立ちそうな情報を集めながらよく読んで、熟孝した後新資料作りを始めてください。

---

今までの経験を振り返り、熟孝して　docs/setup/cline/user-readme/role/phase/analysis-improvement　以下の資料を最大限追記、改善してください
この資料は古いガイドラインに沿って作られているので、大幅な見直しが必要です。
なので、新しいガイドラインに従った新資料は、　analysis-improvement1フォルダを作成した後、そこに作成してください。
また、新資料を作成する前は旧資料を、ガイドライン追記に役立ちそうな情報を集めながらよく読んで、熟孝した後新資料作りを始めてください。
