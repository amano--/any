...
今までの経験を振り返り、熟孝して　docs/setup/cline/user-readme/role/phase/analysis-improvement1　以下の資料を最大限追記、改善してください
この資料は古いガイドラインに沿って作られているので、大幅な見直しが必要です。
なので、新しいガイドラインに従った新資料は、　analysis-improvement2フォルダを作成した後、そこに作成してください。
