...
1. 確認対象
   ...
   ```bash
   list_files docs/team/[teamName]/rules/
   ```
...
- docs/setup/cline/rules/00-personal.md　をテンプレートにして作成

### 1.2 チームルール

- docs/setup/cline/rules/01-team.md　をテンプレートにして作成

### 1.3 プロジェクトルール

- docs/setup/cline/rules/02-project.md　をテンプレートにして作成
```
